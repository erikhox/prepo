...
class TestFeaturePreProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data = {
            ...
            'long_text': ['This is a very long description that exceeds 100 characters and should be classified as text type rather than string type.'] * 5
        }
    ...
    def test_clean_outliers(self):
        ...
        outlier_data = {
            ...
            'with_outliers': [1, 2, 3, 4, 1000]  # 1000 is an outlier
        }
        outlier_df = pd.DataFrame(outlier_data)
        
        datatypes = {
            'normal_values': DataType.NUMERIC,
            'with_outliers': DataType.NUMERIC
        }
    ...
    def test_scaling_methods(self):
        ...
        numeric_cols = [col for col, dtype in datatypes.items() 
